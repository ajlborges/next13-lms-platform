...
async function POST(req, { params }) {
    try {
        ...
        let stripeCustomer = await db.db.stripeCustomer.findUnique({
            where: {
                userId: user.id
            },
            select: {
        ...
        if (!stripeCustomer) {
            const customer = await stripe/* stripe */.A.customers.create({
                email: user.emailAddresses[0].emailAddress
            });
            stripeCustomer = await db.db.stripeCustomer.create({
                data: {
                    userId: user.id,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fcourses%2F%5BcourseId%5D%2Fcheckout%2Froute&name=app%2Fapi%2Fcourses%2F%5BcourseId%5D%2Fcheckout%2Froute&pagePath=private-next-app-dir%2Fapi%2Fcourses%2F%5BcourseId%5D%2Fcheckout%2Froute.ts&appDir=%2Fhome%2Fmrchike%2Fcode%2Ffeatures%2Fnext13-lms-platform%2Fapp&appPaths=%2Fapi%2Fcourses%2F%5BcourseId%5D%2Fcheckout%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/courses/[courseId]/checkout/route","pathname":"/api/courses/[courseId]/checkout","filename":"route","bundlePath":"app/api/courses/[courseId]/checkout/route"},"resolvedPagePath":"/home/mrchike/code/features/next13-lms-platform/app/api/courses/[courseId]/checkout/route.ts","nextConfigOutput":""}
...
var __webpack_exports__ = __webpack_require__.X(0, [652,4813,4425,9565,5501,8579], () => (__webpack_exec__(8233)));
