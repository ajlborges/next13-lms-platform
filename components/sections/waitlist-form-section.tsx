  ...
  return (
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-medium overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-10 pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          <motion.div
            ...
            className="flex flex-row justify-center z-10 mx-0 mb-0 mt-8 md:mt-10 md:mb-[35px] max-w-2xl md:space-x-8"
          >
            <Waitlist />
          </motion.div>
        </main>
